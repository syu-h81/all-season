...
$refrom_name = "株式会社オールシーズン";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "【株式会社オールシーズン】お問い合わせありがとうございます";
...
担当者が確認次第、ご返信いたしますので今しばらくお待ちください。
...
<section class="common-sec">
  <div class="content">
    ...
    <p class="p-1">入力内容をご確認ください。</p>
    
		<?php if($empty_flag == 1){ ?>

			<p>入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</p>
			<?php echo $errm; ?>
      <center><button type="button" class="back-btn" onClick="history.back()">← 入力内容を修正する</button></center>
...
<div id="pagetop"><a href="#"><img src="images/common/pagetop.svg"></a></div>
...
function mailToAdmin($arr,$subject,$mailFooterDsp,$mailSignature,$encode,$confirmDsp){
	$adminBody="ホームページからお問い合わせがありました。\n\n";
